getwd()
setwd("C:/Users/swu/Documents/facul/TCC/Projeto/Scientific_Initiation/src/Teste_Christofides")
...
#population
df_cities_population <- df[, c(1,3)] #population column
for(val in 1:n){
...
transportcost_func <- function(i, j) {
  ...
  return(distanc(customer$x, warehouse$x, customer$y, warehouse$y) 
         * (2.5/25) * (warehouse$warehouse_size * 12/0.3) * 10)
